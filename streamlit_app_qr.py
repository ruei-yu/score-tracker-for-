...
with tabs[2]:
    ...
    color_map = {
     "帶人開法會": "#FF3B30",          # 紅 - 強烈熱情
        "法會護持一天": "#FF9500",        # 橙 - 穩定溫暖
        "參與獻供": "#FFD60A",            # 黃 - 明亮積極
        "活動護持 (含宿訪)": "#34C759",    # 綠 - 活力和平
        "參與晨讀": "#00C7BE",            # 青綠 - 清新平靜
        "參與讀書會/ 與學長姐有約": "#007AFF",  # 藍 - 專注學習
        "上研究班 (新民、至善)": "#5856D6",    # 靛藍 - 穩重智慧
        "參與辦道": "#AF52DE",            # 紫 - 精進莊嚴
        "參與成全/道務會議": "#BF5AF2",     # 粉紫 - 柔和支持
        "帶人求道": "#FFD700",            # 金 - 成就榮耀
        "帶人進研究班": "#A1887F",        # 棕 - 穩重成熟
        "練講": "#8E8E93",               # 灰 - 中性專注
        "背誦經典": "#E5E5EA",            # 淺灰白 - 純淨收尾
     }
